    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'Model_Rice_WC_251/trained_model') 
...
## Graph Title 
plt.title("All Augmented CLoDSA and Original Images 251 Epochs")

## X-axis values range
plt.xlim(0,300)
plt.plot(epoch_arr, acc_arr, label='Training Accuracy', color='blue')
plt.plot(epoch_arr, val_acc_arr, label='Validation Accuracy', color='green')
plt.plot(epoch_arr, val_loss_arr, label='Validation Loss', color='red')

## Figure legend position
plt.legend(loc='upper right')

## Figure save location and figure name
plt.savefig("./plot_251_epochs.png")
